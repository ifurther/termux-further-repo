...
echo "deb https://ifurther.github.io/termux-further-repo/ termux extras" > $PREFIX/etc/apt/sources.list.d/pointless.list
echo "deb https://ifurther.github.io/termux-further-repo/ termux main" > $PREFIX/etc/apt/sources.list.d/pointless.list
fi
